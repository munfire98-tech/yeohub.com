...
tr.noterow td{vertical-align:top}
.notebox{min-height:64px;display:block}
...
@media print{
  ...
  body{background:#fff}
  .sheet{box-shadow:none;border:0;margin:0;max-width:none;width:100%;border-radius:0;padding:0;page-break-after:always}
  ...
  /* 체크박스 항목이 한 줄에 안 들어가면 자연스럽게 줄바꿈되게 (강제 nowrap 제거) */
