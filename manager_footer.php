...
/* Compact management-page footer, independent of the shared site footer. */
.site-footer.manager-footer{margin-top:28px;background:transparent}
.manager-footer .footer-inner{max-width:1600px;padding:22px 32px 18px}
.manager-footer .footer-top{align-items:center;gap:20px;margin-bottom:16px}
.manager-footer .footer-brand{flex:1 1 140px}
.manager-footer .footer-logo{font-size:15px;letter-spacing:.09em;margin:0;color:#64748b}
.manager-footer .footer-desc{display:none}
.manager-footer .footer-cols{gap:18px;align-items:center}
.manager-footer .footer-col{display:flex;flex-wrap:wrap;gap:6px 14px;min-width:0}
.manager-footer .footer-col__t{display:none}
.manager-footer .footer-col a{font-size:11px;padding:4px 0;color:#637187}
.manager-footer .footer-divider{margin-bottom:12px}
.manager-footer .footer-info{font-size:11px;gap:3px 18px;line-height:1.7;color:#7b8799}
.manager-footer .footer-info b{font-weight:500;color:#68768b}
.manager-footer .footer-bottom{margin-top:12px;padding-top:0;border:0;gap:8px}
.manager-footer .footer-bottom p,.manager-footer .footer-pay{font-size:10px;color:#7b8799}
@media(max-width:800px){.manager-footer .footer-inner{padding:20px}.manager-footer .footer-top{align-items:flex-start;gap:12px}.manager-footer .footer-brand{flex-basis:100%}.manager-footer .footer-cols{gap:6px 18px;flex-wrap:wrap}}
@media(max-width:420px){.manager-footer .footer-inner{padding:18px 12px}}
</style>

<footer class="site-footer manager-footer">
